...
begin
  ...
  --clocks
  clk_20m_vcxo_i <= not clk_20m_vcxo_i after 25ns;
  clk_125m_pllref_p_i <= not clk_125m_pllref_p_i after 4ns;
  clk_125m_pllref_n_i <= not clk_125m_pllref_p_i;

  fpga_pll_ref_clk_101_p_i <= not fpga_pll_ref_clk_101_p_i after 4ns;
  fpga_pll_ref_clk_101_n_i <= not fpga_pll_ref_clk_101_p_i;

  fpga_pll_ref_clk_123_p_i <= not fpga_pll_ref_clk_123_p_i after 4ns;
  fpga_pll_ref_clk_123_n_i <= not fpga_pll_ref_clk_123_p_i;

  si57x_clk_p_i <= not si57x_clk_p_i after 4ns;
